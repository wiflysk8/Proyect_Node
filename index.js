...
const skaterRoutes = require('./api/routes/skaters.routes');
const spotRoutes = require('./api/routes/spots.routes');
...
server.use("/skate", skateRoutes);
server.use("/skater", skaterRoutes);
server.use("/spot", spotRoutes);
